...
See [database-design.md](../docs/database-design.md) and [001_init_trial_corpus.sql](../apps/api/db/migrations/001_init_trial_corpus.sql) for the concrete Postgres + pgvector storage design.
